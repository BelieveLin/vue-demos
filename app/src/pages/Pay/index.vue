    ...
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="otherpay">
          ...
          <div class="step-cont">
            <span><a href="javascript:void(0);">微信支付 </a></span>
            <span><a href="javascript:void(0);">中国银联</a></span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getPayInfo() {
      try {
        await this.$store.dispatch("pay/getPayInfo", { orderId: this.orderId });
      } catch (err) {
      ...
      try {
        ...
        if (!this.timer) {
          this.timer = setInterval(async () => {
            const code = await this.$store.dispatch("pay/getPayStatus", {
