  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li class="cart-th1">
            <img :src="order.imgUrl" alt="" style="width: 82px" />
          </li>
          <li class="cart-th2">
            <p>
              {{ order.skuName }}
          ...
          <li class="cart-th4">X{{ order.skuNum }}</li>
          <li class="cart-th5">有货</li>
        </ul>
      </div>
      <div class="bbs">
        <h5>买家留言：</h5>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收件人：<span>{{ userDefaultAddress.consignee }} </span>
        <span>{{ userDefaultAddress.phoneNum }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a href="javascript:void(0);" class="subBtn" @click="submitOrderInfo"
        >提交订单</a
      >
    </div>
  </div>
...
export default {
      ...
      addressList: [
        {
          ...
          isDefault: "0",
          regionId: 1,
          fullAddress: "北京市昌平区北七家镇白庙村129号",
        },
        {
          id: 2,
          userAddress: "上海市静安区江宁路398号",
          userId: 2,
          provinceId: 1,
          consignee: "赵强",
          ...
          isDefault: "0",
          regionId: 1,
          fullAddress: "上海市静安区江宁路398号",
        },
        {
          id: 3,
          userAddress: "四川省成都市龙泉驿区幸福大道627号",
          userId: 2,
          provinceId: 1,
          consignee: "张华",
          ...
          isDefault: "0",
          regionId: 1,
          fullAddress: "四川省成都市龙泉驿区幸福大道333号",
        },
      ],
    };
  },
  computed: {
    ...
    ...mapState("trade", ["orderInfo", "orderId"]),
    userDefaultAddress() {
  ...
  methods: {
    ...
    async submitOrderInfo() {
      ...
      if (confirm("是否确认提交？")) {
        ...
        try {
          await this.$store.dispatch("trade/submitOrderInfo", {
