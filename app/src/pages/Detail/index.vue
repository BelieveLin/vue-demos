            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  @change="changeSkuNum"
                />
                <a href="javascript:void(0);" class="plus" @click="skuNum++"
                  >+</a
                >
                <a
              ...
              <div class="add">
                <a href="javascript:void(0);" @click="addShopCart"
                  >加入购物车</a
                >
              </div>
            </div>
      ...
      <div class="detail">
        ...
        <div class="intro">
          <ul class="tab-wraped">
            ...
            <li>
              <a href="javascript:void(0);"> 手机社区 </a>
            </li>
          </ul>
...
export default {
  ...
  methods: {
    ...
    // 修改商品个数，防抖
    changeSkuNum: debounce(function (e) {
      let value = e.target.value;
      if (isNaN(value) || value < 1) this.skuNum = 1;
      else this.skuNum = parseInt(this.skuNum);
    }, 500),
    // 加入购物车
    async addShopCart() {
      try {
  ...
  mounted() {
    this.$store.dispatch("detail/getGoodInfo", {
      skuId: this.$route.params.skuid,
    });
  },
};
